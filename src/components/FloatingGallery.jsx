...
const FloatingGallery = () => {
    const photoData = [
        { id: 1, img: "1.jpg", text: "لازم تبقي فخوره باي حاجه بتعمليها لان المحاوله لوحدها بالتعب والظروف الي كنتي فيه تكفي ♥️ ", date: "Forever" },
        { id: 2, img: "2.jpg", text: "اي حاجه بتحبيها انا كمان هحبها واي حاجه تتمنيها هجبهالك من غير ماتطلبي المهم رضاكي عنا يامولاتي ♥️♥️", date: "Always" },
        {
            id: 3, img: "3.jpg", text: `بداية جديدة لدكتورة عظيمة ❤️
خطوة أولى في طريق مليان نجاح وإنجازات، وإن شاء الله أشوفك دايمًا في المكان اللي تستحقيه.
Proud of you, My Dr. Malak. 🥼💊`, date: "Together"
        },
        { id: 4, img: "4.jpg", text: "العيون الحلوه دي بعد ازنك مينفعش تعيط غير من الفرحه وهي قتلتني عفكرا ", date: "Happy" },
    ];
